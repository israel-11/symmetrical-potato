                ...
                <div class="left_content">
                    <div class="fashion_technology_area">
                        <div class="fashion">
                            ...
                            <h2><a style="color: white;" href="http://localhost/cienciaprwp/category/escuela"><span>K-12 Students</span></a></h2>
                              <?php
                              $first = true;
                              wp_reset_query();
                              $args = array(
                        ...
                        <div class="technology">
                            <div class="single_post_content">
                            <h2><a style="color: white;" href="http://localhost/cienciaprwp/category/subgraduados"><span>Undergrad Students</span></a></h2>
                              <?php
                              $first = true;
                              wp_reset_query();
                              $args = array(
            ...
            <div class="col-lg-8 col-md-8 col-sm-8">
                <div class="left_content">
                    <div class="fashion_technology_area">
                        <div class="fashion">
                            <div class="single_post_content">
                            <h2><a style="color: white;" href="http://localhost/cienciaprwp/category/graduados"><span>Grad Students</span></a></h2>
                        ...
                        <div class="technology">
                          <div class="single_post_content">
                          <h2><a style="color: white;" href="http://localhost/cienciaprwp/category/postdocs"><span>Postdocs</span></a></h2>
                            <?php
                            $first = true;
                            wp_reset_query();
                            $args = array(
            ...
            <div class="col-lg-4 col-md-4 col-sm-4">
                <aside class="right_content">
                    ...
                    <div style="width:100%" class="fashion">
                        <div class="single_post_content">
                        <h2><a style="color: white;" href="http://localhost/cienciaprwp/category/trabajos"><span>Jobs</span></a></h2>
                        <?php
                        $first = true;
                        wp_reset_query();
                        $args = array(
