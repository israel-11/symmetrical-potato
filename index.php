    ...
    <nav class="navbar navbar-inverse" role="navigation">
      ...
      <div id="navbar" class="navbar-collapse collapse">
        <ul class="nav navbar-nav main_nav">
          <li class="active"><a style="background-color:#AED581;" href="index.html"><span class="fa fa-home desktop-home"></span><span class="mobile-show">Home</span></a></li>
          ...
          <div class="latest_post_container">
            ...
            <ul class="latest_postnav">
              ...
              <?php
                          ...
                          while($news->have_posts()) : $news -> the_post(); ?>
                          <li>
                                          <div class="media"> <a href="<?php the_permalink(); ?>" class="media-left"> <img alt="" src="images/post_img1.jpg"> </a>
